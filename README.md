...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-kc63bjy.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-kc63bjy.containers.anotherwebservice.com/
...
```
git clone git@github.com:whitebrow/container-kc63bjy.git
cd container-kc63bjy
```
...
```
docker attach container-kc63bjy
```
